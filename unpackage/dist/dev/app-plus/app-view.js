...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'display:flex;justify-content:center;font-size:100rpx;'])
...
var x=['./components/common/divider.wxml','./pages/cart/cart.wxml','./pages/ceshi/ceshi.wxml','./pages/class/class.wxml','./pages/my/my.wxml'];d_[x[0]]={}
...
var z=gz$gwx_3()
var cF=_n('view')
var hG=_mz(z,'button',['bindtap',0,'data-event-opts',1,'type',1],[],e,s,gg)
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:5033:1)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:5033:1)",{path:"./app.wxss"});    
